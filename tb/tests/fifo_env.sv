...
class fifo_env extends uvm_env;
  ...
  extern function void connect_phase(uvm_connect_phase phase);
...
function void fifo_env::build_phase(uvm_build_phase phase);
...
function void fifo_env::connect_phase(uvm_connect_phase phase);
...
function void fifo_env::end_of_elaboration_phase(uvm_end_of_elaboration_phase phase);
  super.end_of_elaboration_phase(phase);
  `uvm_info("ENV", "fifo_env end_of_elaboration_phase", UVM_LOW)
endfunction

function void fifo_env::start_of_simulation_phase(uvm_start_of_simulation_phase phase);
  super.start_of_simulation_phase(phase);
  `uvm_info("ENV", "fifo_env start_of_simulation_phase", UVM_LOW)
endfunction

function void fifo_env::extract_phase(uvm_extract_phase phase);
  super.extract_phase(phase);
  `uvm_info("ENV", "fifo_env extract_phase", UVM_LOW)
endfunction

function void fifo_env::check_phase(uvm_check_phase phase);
  super.check_phase(phase);
  `uvm_info("ENV", "fifo_env check_phase", UVM_LOW)
endfunction

function void fifo_env::report_phase(uvm_report_phase phase);
  super.report_phase(phase);
  `uvm_info("ENV", "fifo_env report_phase", UVM_LOW)
endfunction

function void fifo_env::final_phase(uvm_final_phase phase);
